...
.btn-link.danger:hover { background-color: var(--color-danger-bg); }
...
.btn-sm.btn-success { background-color: var(--color-success); color: white; }
.btn-sm.btn-warning { background-color: var(--color-warning); color: white; }
